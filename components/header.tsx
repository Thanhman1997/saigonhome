...
export function Header({ navigationSettings = [] }: { navigationSettings?: NavigationSetting[] }) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/90 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:h-20 lg:h-24 lg:px-8">
        <a href="#top" onClick={(event) => { event.preventDefault(); navigate("#top") }} className="group flex items-center lg:-translate-x-16" aria-label="Lotus Wellness home">
          <Image src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-ctVp17KBG47Gf3slo2vkFOzNoBGmVU.png" alt="Lotus Wellness Massage" width={150} height={112} priority className="h-14 w-auto object-contain sm:h-16 lg:h-24" />
        </a>
