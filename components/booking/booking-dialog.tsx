      ...
      <DialogContent className="max-h-[98vh] max-w-6xl overflow-y-auto p-0" showCloseButton>
        ...
        <div className="flex flex-col">
          <div className="border-b border-border px-6 py-5">
            <div className="flex items-center justify-between gap-4"><Image src="/images/lotus-round-logo.png" alt="Lotus Wellness" width={72} height={72} className="size-16 rounded-full object-contain" /><p className="text-right text-2xl font-semibold uppercase tracking-[0.2em] text-accent sm:text-3xl">{t.booking.title}</p></div>
            {step !== "confirm" && (
