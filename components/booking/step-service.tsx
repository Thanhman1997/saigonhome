    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {services.map((service) => {
          ...
          return (
            <div key={service.id} className={cn("flex h-40 flex-col border p-3 transition-colors", isSelected ? "border-primary bg-muted" : "border-border")}>
              ...
              <div className="mt-2 flex h-[5.75rem] justify-end" aria-label={`${name} duration`}>
