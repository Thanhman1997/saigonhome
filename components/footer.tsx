  ...
  return (
    <footer className="border-t border-border bg-secondary px-5 py-10 font-sans text-sm text-foreground lg:px-8">
      <div className="mx-auto grid max-w-6xl gap-2 md:grid-cols-3 md:translate-x-[1.5cm]">
        <div>
          <h2 className="font-sans text-sm font-semibold uppercase tracking-[0.12em] text-guiding-pink">{footerCopy.services}</h2>
        ...
        <div id="contact" className="text-foreground">
          <h2 className="font-sans text-sm font-semibold uppercase tracking-[0.12em] text-guiding-pink">{footerCopy.working}</h2>
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <p className="text-base leading-6 text-muted-foreground">{footerCopy.note.split("\n").map((line) => <span key={line}>{line}<br /></span>)}</p>
          </div>
        </div>
      </div>
