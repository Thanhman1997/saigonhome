  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className={cn("relative w-40 overflow-hidden rounded-lg border border-dashed border-border bg-muted", aspect)}>
        {value ? <Image src={value} alt="" fill className="object-cover" unoptimized /> : <div className="flex h-full items-center justify-center text-muted-foreground"><ImagePlus className="size-6" /></div>}
