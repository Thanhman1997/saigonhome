...
const groups = [
  ...
  { label: "Website", items: [{ href: "/admin/pages", label: "All content", icon: PanelsTopLeft }, { href: "/admin/hero", label: "Hero", icon: Sparkles }, { href: "/admin/about", label: "About", icon: BookOpen }, { href: "/admin/services", label: "Services", icon: ClipboardList }, { href: "/admin/therapists", label: "Therapists", icon: Users }, { href: "/admin/promotions", label: "Promotions", icon: FileText }, { href: "/admin/reviews", label: "Reviews", icon: BarChart3 }, { href: "/admin/faq", label: "FAQ", icon: BookOpen }] },
  ...
  { label: "Settings", items: [{ href: "/admin/design", label: "Design", icon: Palette }, { href: "/admin/media", label: "Media library", icon: ImageIcon }, { href: "/admin/languages", label: "Languages", icon: Languages }, { href: "/admin/contact", label: "Contact", icon: Settings2 }, { href: "/admin/booking-settings", label: "Booking settings", icon: Settings2 }, { href: "/admin/preview", label: "Preview", icon: Eye }] },
]
