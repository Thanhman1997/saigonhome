...
export function ReviewForm() {
  ...
  return <form onSubmit={onSubmit} className="flex flex-col gap-4 rounded-2xl border border-border bg-card p-5 sm:p-7">
    ...
    <div className="flex flex-col gap-2"><Label htmlFor="review-comment">Your experience</Label><Textarea id="review-comment" name="comment" rows={5} required minLength={10} /></div>
