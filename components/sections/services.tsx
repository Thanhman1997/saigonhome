    ...
    <section id="services" className="bg-muted py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          {t.services.kicker ? <p className="text-center font-sans text-[clamp(4rem,7vw,7.5rem)] font-black leading-[1.05] tracking-[-0.03em] text-accent">{localizedContent(servicesContent.kickerEn, servicesContent.kickerKo, servicesContent.kickerVi)}</p> : null}
          <h2 className="mt-4 text-center font-sans text-[clamp(2.5rem,4vw,4.5rem)] font-bold leading-[1.15] tracking-[-0.02em] text-accent">{localizedContent(servicesContent.titleEn, servicesContent.titleKo, servicesContent.titleVi)}</h2>
