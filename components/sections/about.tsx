    ...
    <section id="about" className="bg-background py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className={`mt-0 text-balance text-lg font-extrabold leading-tight tracking-tight text-guiding-pink ${locale === "ko" ? "font-korean-serif text-5xl sm:text-6xl lg:text-7xl" : "font-serif text-5xl sm:text-6xl lg:text-7xl"}`}>{title}</h2>
