    ...
    <section id="about" className="bg-background py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className={`mt-0 text-balance font-extrabold leading-tight tracking-tight text-guiding-pink ${locale === "ko" ? "font-korean-sans tracking-tight" : "font-serif"}`} style={{ fontSize: "clamp(2.25rem, 4.5vw, 4rem)" }}>{title}</h2>
