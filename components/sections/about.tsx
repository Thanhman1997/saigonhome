    ...
    <section id="about" className="bg-secondary/35 py-20 lg:py-28">
      <div className="mx-auto max-w-[100rem] px-5 lg:px-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className={`mt-0 text-balance text-[clamp(2rem,4vw,3.5rem)] font-extrabold leading-tight tracking-tight text-guiding-pink ${locale === "ko" ? "font-korean-sans tracking-[-0.02em]" : "font-sans tracking-[-0.02em]"}`}>{title}</h2>
