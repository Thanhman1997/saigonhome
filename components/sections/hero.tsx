      ...
      <div className="mx-auto grid max-w-[80rem] items-center gap-6 px-8 lg:grid-cols-[.85fr_1.15fr] lg:gap-8 lg:px-20">
        <div className="flex flex-col justify-center py-8 sm:py-10 lg:py-8 lg:pl-4">
          {content.visible && <>
            ...
            <h1 className={`max-w-3xl text-balance font-sans font-normal leading-tight tracking-[-0.035em] ${locale === "ko" ? "font-korean-sans" : ""}`} style={{ fontSize: "clamp(2rem, 4.3vw, 4.1rem)" }}>{localized(content.titleLine1En, content.titleLine1Ko, content.titleLine1Vi)}<br /><span className="font-inherit text-accent capitalize">{localized(content.titleLine2En, content.titleLine2Ko, content.titleLine2Vi)}</span></h1>
