...
export function HeroSection({ hero }: { hero: Hero }) {
  ...
  return (
    <section id="top" className="relative min-h-[calc(100svh-5rem)] overflow-hidden bg-secondary text-foreground">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(90deg,var(--secondary)_0%,color-mix(in_oklab,var(--secondary)_96%,transparent)_38%,color-mix(in_oklab,var(--secondary)_46%,transparent)_62%,transparent_78%)]" />
