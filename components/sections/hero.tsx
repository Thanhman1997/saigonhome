    ...
    <section id="top" className="overflow-hidden bg-card text-foreground">
      <div className="mx-auto grid max-w-7xl lg:grid-cols-[.85fr_1.15fr]">
        <div className="flex flex-col justify-center px-5 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-8">
          {content.visible && <>
            <div className={`reveal-up mb-5 flex items-center gap-3 font-sans text-sm font-semibold tracking-wide text-accent ${locale === "ko" ? "font-korean-sans" : ""}`}><ShieldCheck className="size-4" />{localized(content.kickerEn, content.kickerKo, content.kickerVi)}</div>
