...
export function ExperienceVideo({ videoUrl }: { videoUrl?: string | null }) {
  ...
  return (
    <section className="experience-video border-y border-border/70 bg-header-background py-24 lg:py-32" aria-labelledby="experience-video-title">
      <div className="mx-auto grid max-w-[100rem] gap-10 px-5 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:gap-10 lg:px-16">
        ...
        <div className="group relative w-full max-w-full justify-self-end overflow-hidden rounded-[1.5rem] border border-border/70 bg-secondary p-1.5 shadow-[0_24px_70px_-42px_rgba(92,48,20,0.65)] lg:w-2/3">
