...
export default async function DashboardPage() {
  ...
  return <div className="flex flex-col gap-8">
    ...
    <div className="flex flex-wrap gap-3"><Button asChild><Link href="/admin/bookings"><CalendarDays className="size-4" />Manage bookings</Link></Button><Button asChild variant="outline"><Link href="/admin/services"><FileText className="size-4" />Update services</Link></Button><Button asChild variant="outline"><Link href="/admin/pages"><FileText className="size-4" />Edit website content</Link></Button></div>
